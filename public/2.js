    ...
    loggin: function loggin() {
      ...
      axios.get("".concat(this.ip, "/?nomFun=tb_login&parm_cod=Xyfk8Gixnf&parm_new=0&parm_pin=").concat(this.password, "&parm_tipo=M$")).then(function (_ref) {
        ...
        if (data.status === 1) {
          ...
          _this.$store.commit("SET_PISOS", JSON.stringify(data.pisos));

          _this.$store.commit("SET_FAMILIAS", JSON.stringify(data.fam));
        ...
        [
          _c(
            ...
            [
              _c(
                "v-card-title",
                { staticClass: "text-center headline mt-3" },
                [
                  _c("v-text-field", {
                    staticClass: "centered-input white--text mt-3",
                    attrs: {
                      type: "password",
                      maxlength: "4",
                      counter: 4,
              ...
              _c("v-card-text", [
                _c(
                  ...
                  {
                    staticClass:
                      "vuertual-numeric-keyboard bg-light rounded border p-3"
                  },
